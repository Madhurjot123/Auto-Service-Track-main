...
@web_app.route("/")
def login():
    return render_template("customer-web.html")


@web_app.route("/login-customer")
def index():
...
def register_service_station():
    ...
    if existing_station:
        return render_template('error4.html', message=f'{email} already registered')
...
def login_service_station():
    ...
    if len(documents) == 1:
        ...
        return render_template('error1.html', message="Incorrect Email And Password ")
